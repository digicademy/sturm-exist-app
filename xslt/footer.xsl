    ...
    <xsl:template name="footer">
        <section class="six columns service">
            ...
            <p>
                ...
                Die Editionssoftware dieses Projektes steht unter MIT-Lizenz und kann <a href="{$relativeToAppBase}ressourcen/software.html">frei heruntergeladen</a> und 
        ...
        <section class="six columns contact">
            ...
            <address x-ms-format-detection="none" vocab="http://schema.org/" typeof="Organization">
                ...
                E-Mail: <span property="email">
                    <a href="mailto:redaktion@sturm-edition.de">redaktion@sturm-edition.de</a>
                </span>
                <br/>
                Twitter: <a class="twitter" href="https://twitter.com/SturmEdition">@SturmEdition</a>
                <br/>
                <a class="imprint" href="{$relativeToAppBase}impressum.html">Impressum</a>
